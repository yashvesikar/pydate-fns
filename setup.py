...
setup(
    ...
    description="A Python3 implementation of the popular Javascript date library date-fns",
    ...
    url="https://github.com/yashvesikar/pydate",  # Optional
